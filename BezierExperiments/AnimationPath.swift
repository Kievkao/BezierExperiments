...
class AnimationPath: UIBezierPath {
    ...
    init(zeroPoint zPoint: CGPoint, shapeSideLength sideLength: CGFloat) {
        ...
        addCurve(to: animationFinishPoint, controlPoint1: randomPoint1, controlPoint2: randomPoint2)
    }
    ...
    func randomPoint(minX: CGFloat, maxX: CGFloat, minY: CGFloat, maxY: CGFloat) -> CGPoint {
